station-event-bluespace-vault-start-announcement = Автономный бронированный транспортный модуль совершил ошибку при блюспейс-переходе и вскоре прибудет в ваш сектор. За его безопасное возвращение секторальный аванпост получит вознаграждение.
...
station-event-bluespace-vault-end-announcement = Транспортный модуль успешно извлечён из вашего сектора. Ближайший секторальный аванпост получил соответствующую компенсацию. Слава ТСФ!
...
station-event-bluespace-cache-end-announcement = Контрабандный транспорт успешно извлечён из вашего сектора. Ближайший секторальный аванпост получил соответствующую компенсацию. Слава ТСФ!
...
station-event-bluespace-ship-end-announcement = В соответствии с протоколами блюспейс-передвижений, неизвестный шаттл был уничтожен.

station-event-bluespace-syndicate-ftl-interception-start-announcement = Внимание, исследователи дальнего космоса! Управление секториальным флотом ТСФ сорвало блюспейс-прыжок шаттла враждебной организации. Согласно данным сканеров дальнего космоса, шаттл либо уже вошел в пространство вашего сектора, либо вот-вот войдёт. Код: Перехватить, Уничтожить, Истребить, Сжечь. Ожидается вооружённое сопротивление, применение смертельной силы против вражеских агентов разрешено. Напоминаем: любые потери персонала, связанного с NanoTrasen, не будут компенсированы. Не допускайте капитанов, аффилированных с NT, без допуска безопасности, от получения доступа к вражескому кораблю и его содержимому.
...
station-event-bluespace-syndicate-ftl-interception-end-announcement = В соответствии с протоколами блюспейс-передвижений, неизвестный шаттл был уничтожен.

station-event-bluespace-wizardfederation-scout-start-announcement = Внимание, исследователи дальнего космоса! Управление секториальным флотом ТСФ обнаружило блюспейс-аномалию в вашем секторе с сигнатурой, указывающей на скорое прибытие шаттла Федерации Волшебников. Код: Перехватить, Задержать, Заключить. Арестуйте нарушителей и подготовьте их к передаче подразделению ТСФ NanoTrasen для проведения допроса.
...
station-event-bluespace-wizardfederation-scout-end-announcement = В соответствии с протоколами блюспейс-передвижений, шаттл Федерации Волшебников был уничтожен.
...
station-event-bluespace-bloodmoon-end-announcement = В соответствии с протоколами блюспейс-передвижений, шаттл Кровавой Луны был уничтожен.

station-event-bluespace-generic-ftl-start-announcement = Внимание, исследователи дальнего космоса! Управление секториальным флотом ТСФ обнаружило неидентифицированный шаттл, входящией в сектор Жандер. Капитаны, аффилированные с NanoTrasen, должны проявлять осторожность. Федерация не несет ответственности за полученные повреждения или потерю жизни.
...
station-event-bluespace-generic-ftl-end-announcement = В соответствии с протоколами блюспейс-передвижений, неидентифицированный шаттл был уничтожен для избежания столкновения.

station-event-bluespace-dungeon-start-announcement = Обнаружены признаки приближающегося крупного планетоида. Проведите расследование планетоида с осторожностью, Федерация не несёт ответственности за причинённый ущерб или гибель членов экипажа.
...
station-event-bluespace-name-SecureNTVault = Безопасное хранилище
