...
ent-ClothingBackpackDuffelSyndicateFilledSMG = набор C-20R «Рейд»
    .desc = Старый добрый классический пистолет-пулемет C-20R в комплекте с тремя магазинами.
ent-ClothingBackpackDuffelSyndicateFilledRevolver = набор R-2 «Питон»
    .desc = Выступите громко и гордо с заряженным Магнум Питон и двумя спидлоадерами.
ent-ClothingBackpackDuffelSyndicateFilledLMG = набор L-6A «Мучитель»
    .desc = Еще больше дакки: культовый лёгкий пулемет L6 в комплекте с 2 коробами патронов.
ent-ClothingBackpackDuffelSyndicateFilledGrenadeLauncher = набор GL-16 «China-Lake»
...
ent-ClothingBackpackDuffelSyndicateMedicalBundleFilled = набор медикаментов
    .desc = Все, что нужно для возвращения в строй ваших товарищей: главным образом, боевая аптечка, дефибриллятор и три боевых автоинъектора.
...
ent-ClothingBackpackDuffelSyndicateFilledAtreides = набор WT-312 «Атрейдс»
    .desc = Стильный и смертоносный: компактный одноручный пистолет-пулемёт, используемый стариками из Синдиката, а также три магазина к нему.
