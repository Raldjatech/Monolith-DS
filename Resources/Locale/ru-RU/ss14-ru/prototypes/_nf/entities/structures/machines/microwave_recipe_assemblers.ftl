...
ent-KitchenDeepFryerCauldron = фритюрница
    .desc = Большая ёмкость с кипящим маслом. Идеально подходит для приготовления хрустящих блюд и создания проблем со здоровьем.