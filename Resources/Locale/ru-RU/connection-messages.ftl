...
ban-banned-permanent = Этот бан можно только обжаловать. Для этого посетите https://discord.gg/sector-colossus.
ban-banned-permanent-appeal = Этот бан можно только обжаловать. Для этого посетите https://discord.gg/sector-colossus.
...
ban-banned-4 = Для разбана перейдите на Discord-сервер - https://discord.gg/sector-colossus
