...
uplink-meds-bundle-desc = Всё, что нужно для возвращения в строй ваших товарищей! В набор входит две боевых аптечки, дефибриллятор Интердайн, 4 боевых автоинъектора, 8 стимпаков, 4 автоинъектора пунктураза и 4 автоинъектора пиразина.
