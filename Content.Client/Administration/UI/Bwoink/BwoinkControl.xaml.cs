...
using Robust.Client.Graphics; // LuaM
...
namespace Content.Client.Administration.UI.Bwoink
{
    ...
    public sealed partial class BwoinkControl : Control
    {
        ...
        public BwoinkControl()
        {
            ...
            // LuaM-start: blue player selector for the Dead Space AHelp visual.
            ChannelSelector.BackgroundPanel.PanelOverride = new StyleBoxFlat
            {
                BackgroundColor = Color.FromHex("#0B2033F2"),
                BorderColor = Color.FromHex("#247CA2"),
            ...
            ChannelSelector.FilterLineEdit.AddStyleClass(DeadSpaceAHelpStyles.Input);
            // LuaM-end
